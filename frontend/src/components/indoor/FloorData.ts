...
export const LIBRARY_FLOORS: Floor[] = [
  ...
  {
    floorNumber: 0,
    //planImage: "/floor plans/Library/02 ground_0.jpg",
    rooms: [
      {
        id: "lib_reception",
        name: "Reception",
  ...
  {
    floorNumber: 1,
    //planImage: "/floor plans/Library/03 first-1_0.jpg",
    rooms: [
      {
        id: "lib_reading1",
        name: "Reading Area A",
  ...
  {
    floorNumber: 2,
    //planImage: "/floor plans/Library/04 second-1_0.jpg",
    rooms: [
      {
        id: "lib_reading2",
        name: "Reading Area B",
  ...
  {
    floorNumber: 3,
    //planImage: "/floor plans/Library/05 third-1_0.jpg",
    rooms: [
      {
        id: "lib_silent",
        name: "Silent Study",
